...
- [OWASP Devsecops Maturity Model (DSOMM)](https://dsomm.timo-pagel.de) - The OWASP DevSecOps Maturity Model provides opportunities to harden DevOps strategies and shows how these can be prioritized.

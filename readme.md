...
- [Git Tresor](https://github.com/thebitrebels/git-tresor) - _Bitrebels_ - En- and decrypt secret files to store them where they are needed - next to your source code.
